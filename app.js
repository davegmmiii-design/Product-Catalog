...
function renderProductDetail() {
  ...
  document.getElementById('footer-social').innerHTML = `
    <a href="https://wa.me/251911513747" class="footer-social__icon" target="_blank" rel="noopener" aria-label="WhatsApp">
    ...
    <a href="mailto:Primroseplc@gmail.com" class="footer-social__icon" target="_blank" rel="noopener" aria-label="Gmail">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="22,4 12,13 2,4"/></svg>
    </a>
  `;
}
